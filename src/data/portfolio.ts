...
export const works: WorkData[] = [
  ...
  { id: "raspi-dmxbox", title: { ja: "raspi-DMXBox", en: "raspi-DMXBox" }, description: { ja: "Raspberry PiとPythonで構築した、イベント向け照明・音響制御システムです。", en: "An event lighting and audio control system built with Raspberry Pi and Python." }, skills: ["Python", "Linux"], tags: ["Python", "Raspberry Pi", "FastAPI", "DMX", "OSC"], href: "https://github.com/Surigoma/raspi-DMXBox" },
